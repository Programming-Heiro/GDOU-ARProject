...
class FocusSquare: SCNNode {
    ...
    private var focusSquareColor = #colorLiteral(red: 1, green: 0.8288275599, blue: 0, alpha: 1) // base yellow
	private var focusSquareColorLight = #colorLiteral(red: 1, green: 0.9312674403, blue: 0.4846551418, alpha: 1) // light yellow
...
//        let modelScene = SCNScene(named: "Models.scnassets/Boardinghouse.scn")!
//        
//        // Get the model from the root node of the scene
//        let modelNode = modelScene.rootNode.childNode(withName:"boardinghouse", recursively: true)!
//        //wrapNode.addChildNode(modelScene.rootNode)
